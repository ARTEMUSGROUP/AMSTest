...
public class Voyagepage {
	...
	@FindBy(xpath = "//li[@id='dhtmlgoodies_listItem0']//a[contains(text(),'Voyage')]")
	public WebElement voyageTab;

	@FindBy(xpath = "/html/body/table/tbody/tr[2]/td/div/ul[2]/li[1]/a")
	public WebElement voyageschedule;

	@FindBy(xpath = "//td[contains(text(),'Voyage Schedule')]")
	...
	@FindBy(xpath = "//*[@id='scacCodeDiv']/input")
	...
	@FindBy(css = "input[id='reportNumber']")
