...
public class AMSMainScreenPage {
	...
	@FindBy(xpath = "//td[contains(text(),'AMS Main Screen')]")
	...
	@FindBy(xpath = "//input[@name='billDetailInformation']")
	...
	@FindBy(xpath = "//input[@name='originalManifestTracking']")
	public WebElement originalManifestTracking;

	@FindBy(xpath = "//input[@name='billAmendTracking']")
	public WebElement billAmendTracking;

	@FindBy(xpath = " //div[@id='portDetail']//td[4]")
	...
	@FindBy(css = "table[id='billDetailInformationTable']")
	public WebElement billDetailInformationRow;

	@FindBy(xpath = "//div[@id='modal1']//div//div//img")
	public WebElement billDetailInformationExcel;

	@FindBy(css = "table[id='customErrorTable']")
	public WebElement customErrorTableRow;

	@FindBy(xpath = "//*[@id='modal1']/div/div[1]/table")
	public WebElement originalManifestTrackingRow;

	@FindBy(xpath = "//body//div[@id='modal1']//div//div[1]")
