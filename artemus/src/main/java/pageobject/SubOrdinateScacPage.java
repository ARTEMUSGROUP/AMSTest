...
public class SubOrdinateScacPage {
	...
	@FindBy(xpath = "//a[contains(text(),' Sub-Ordinate SCAC')]")
	public WebElement SubOrdinateSCACTab;

	@FindBy(xpath = "//td[contains(text(),'Sub-Ordinate Scac')]")
	public WebElement PageTitle;

	@FindBy(css = "input[name='scacCode']")
	public WebElement scacCode;

	@FindBy(css = "input[name='bondHolder']")
	public WebElement bondHolder;

	@FindBy(css = "select[name='bondActivityCode']")
	public WebElement bondActivityCode;

	@FindBy(css = "select[name='bondType']")
	public WebElement bondType;

	@FindBy(css = "input[name='vnumber']")
	...
	@FindBy(css = "img[alt='Find']")
	public WebElement Find;

	@FindBy(css = "input[name='sCode']")
