...
public class VesselDeparturepage {
	...
	@FindBy(xpath ="//a[contains(text(),'Vessel Departure')]")	public WebElement VesselDeparture;
	...
	@FindBy(css ="input[id='departureDate0']")	public WebElement departureDate;
	
	@FindBy(xpath ="//tr[@class='GridData']")	public WebElement tableRow;

	
	@FindBy(xpath ="//td[contains(text(),'Vessel Departure')]")	public WebElement pageTitle	;
