...
public class SCACCodePage {
	...
	@FindBy(css = "input[name='sName']")
	public WebElement sName;

	@FindBy(css = "input[name='SearchButton']")
	public WebElement SearchButton;

	@FindBy(xpath = "//*[@id='ResponseDiv']/div/table/tbody/tr/td/table/tbody/tr[1]")
	public WebElement GridRow;

	@FindBy(xpath = "//td[contains(text(),'SCAC Code')]")
