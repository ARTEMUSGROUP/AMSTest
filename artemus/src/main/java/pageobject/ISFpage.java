...
public class ISFpage {
	...
	@FindBy(xpath = "//a[contains(text(),'Add Orignal ISF')]")
	public WebElement AddOrignalISF;

	@FindBy(xpath = "//td[contains(text(),'ISF')]")
	...
	@FindBy(css = "select[name='loadPortId']")
	public WebElement loadPortId;

	@FindBy(css = "select[name='dischargePortId']")
	public WebElement dischargePortId;

	@FindBy(css = "img[alt='Find Criteria']")
	public WebElement Find;

	@FindBy(xpath = "//*[@id='StatusTable']/tbody/tr[1]")
	public WebElement billDetailsTable;

	@FindBy(xpath = "//tr[@id='tr0']//td[1]//input[@name='isISFSentCheckBox']")
	public WebElement isISFSentCheckBox;

	@FindBy(css = "input[id='validateISFBill']")
	public WebElement validateISFBill;

	@FindBy(xpath = "//tr[@id='tr0']//td[4]")
	public WebElement ISFsenttd;

	@FindBy(xpath = "//tr[@id='tr0']//td[3]")
	public WebElement ISFError;

	@FindBy(xpath = "//tr[@id='tr0']")
	public WebElement ISFTableRow;

	@FindBy(xpath = "//*[@id='StatusTable']/tbody/tr[1]/td[1]")
	public WebElement SentDate;

	@FindBy(xpath = "//*[@id='StatusTable']/tbody/tr[1]/td[2]")
	public WebElement SentType;

	@FindBy(xpath = "//table[2]//tbody[1]//tr[1]//td[1]//div[1]")
