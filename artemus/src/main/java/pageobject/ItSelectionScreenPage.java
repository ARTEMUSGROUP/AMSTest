...
public class ItSelectionScreenPage {
	...
	@FindBy(xpath = "//a[contains(text(),'IT Selection Screen')]")
	public WebElement ItSelectionScreen;

	@FindBy(xpath = "//td[contains(text(),'It Selection Screen')]")
	...
	@FindBy(xpath = "//body//div[@id='MainDataDiv']//tbody//tbody//tr[1]")
	public WebElement TableRow;

	@FindBy(css = "input[name='shipmentValue']")
	public WebElement shipmentValue;

	@FindBy(css = "select[name='inlandDestination']")
	public WebElement inlandDestination;

	@FindBy(xpath = "//b[contains(text(),'The following fields are required for')]")
	public WebElement Requiredfeilds;

	@FindBy(css = "select[name='foreignDestination']")
	public WebElement foreignDestination;

	@FindBy(css = "input[name='BLCrossReference']")
	public WebElement BLCrossReference;

	@FindBy(xpath = "//*[@id='getBillListTable']/tbody/tr[1]/td[1]/input")
	public WebElement checkbox;

	@FindBy(css = "img[onclick='funSaveNewIt();return false;']")
	public WebElement SaveButtonDiv;

	@FindBy(css = "input[name='ItArrival']")
	public WebElement ItArrival;

	@FindBy(css = "input[name='ItContainerArrival']")
	public WebElement ItContainerArrival;

	@FindBy(css = "input[name='ItBillArrival']")
	public WebElement ItBillArrival;

	@FindBy(css = "input[name='ArrivalAcknowledgement']")
	public WebElement ArrivalAcknowledgement;

	@FindBy(xpath = "//div[@id='ItListDiv']//tbody//tr[1]")
	public WebElement ItBillArrivalTableRow;

	@FindBy(css = "input[name='InputItArrival']")
	public WebElement InputItArrival;

	@FindBy(css = "input[name='InputItExportation']")
	public WebElement InputItExportation;

	@FindBy(css = "input[name='ItArrivalDate']")
	public WebElement ItArrivalDate;

	@FindBy(xpath = "//div[@id='InputItArrivalPopup']//img[@id='img_save']")
	public WebElement ItArrivalDatesave;

	@FindBy(xpath = "//input[@name='CancelItArrival']")
	public WebElement CancelItArrival;

	@FindBy(xpath = "//input[@name='CancelItExportation']")
	public WebElement CancelItExportation;

	@FindBy(xpath = "//input[@name='ShowItArrivalHistory']")
	public WebElement ShowItArrivalHistory;

	@FindBy(xpath = "//div[@id='DisplayDiv']//table//tbody//tr//td//img")
	public WebElement closetab;

	@FindBy(xpath = "//div[@id='ItListDiv']//tbody//tr[1]")
	public WebElement ItContainerArrivalTableRow;

	@FindBy(xpath = "//*[@id='buttonDivItArrival']/table/tbody/tr/td[1]/input")
	public WebElement InputItContainerArrival;

	@FindBy(xpath = "//div[@id='DisplayDiv']//tr[1]//td[6]//input[1]")
	public WebElement Arrivaldatecheck;

	@FindBy(xpath = " //input[@name='InputItContainerExportation']")
	public WebElement InputItContainerExportation;

	@FindBy(xpath = "//input[@name='CancelItContainerArrival']")
	public WebElement CancelItContainerArrival;

	@FindBy(xpath = "//input[@name='CancelItContainerExportation']")
	public WebElement CancelItContainerExportation;

	@FindBy(xpath = "//input[@name='ShowItContainerArrivalHistory']")
	public WebElement ShowItContainerArrivalHistory;

	@FindBy(xpath = "//input[@name='InputItBillArrival']")
	public WebElement InputItBillArrival;

	@FindBy(xpath = "//input[@name='InputItBillExportation']")
	public WebElement InputItBillExportation;

	@FindBy(xpath = "//input[@name='CancelItBillArrival']")
	public WebElement CancelItBillArrival;

	@FindBy(xpath = "//input[@name='CancelItBillExportation']")
	public WebElement CancelItBillExportation;

	@FindBy(xpath = "//input[@name='ShowItBillArrivalHistory']")
	...
	@FindBy(xpath = "//div[@id='buttonDiv']//table//tbody")
	public WebElement TableRowDetails;

	@FindBy(xpath = "//body//div[@id='MainDataDiv']//tbody//tbody//tr[1]//td[1]")
	public WebElement ITNumber;

	@FindBy(css = "div#DisplayDiv table.GridTable")
	public WebElement ITNumberTableRow;

	@FindBy(css = "div#DisplayDiv table.GridTable td:nth-of-type(2)")
	public WebElement ITNumberinItArrival;

	@FindBy(xpath = "//div[@id='buttonDivItArrival']//table//tbody")
	public WebElement buttonDivItArrival;

	@FindBy(xpath = "//table[@id='ItListTable']//tbody//tr[1]//td[4]//input")
	public WebElement ArrivaldateinArrivalTable;

	@FindBy(xpath = "//table[@id='ItListTable']//tbody//tr")
	public WebElement ItArrivalTableRow;

	@FindBy(xpath = "//div[@id='historyDiv']//tbody")
	public WebElement historyDiv;

	@FindBy(xpath = "//div[@id='historyDiv']//tbody//tr[1]//td[2]")
	public WebElement historyDivITnumber;

	@FindBy(xpath = "//table[@id='ItListTable']//tbody//tr[1]//td[6]//input")
	public WebElement ArrivalDateinContenerArrival;

	@FindBy(xpath = "//table[@id='ItListTable']//tbody//tr[1]//td[4]//input")
	public WebElement ItContainerITnumber;

	@FindBy(xpath = "//table[@id='ItListTable']//tbody//tr[1]//td[5]//input")
	public WebElement ArrivaldateinBillarrival;

	@FindBy(xpath = "//table[@id='ItListTable']//tbody//tr[1]//td[3]//input")
