...
public class PermitToTransferPage {
	...
	@FindBy(xpath = "//a[contains(text(),'Permit To Transfer')]")
	public WebElement PermitToTransfer;

	@FindBy(xpath = "//td[contains(text(),'Permit To Transfer')]")
	...
	@FindBy(xpath = "//form[@name='permitToTransfer']//img[@id='img_find']")
	public WebElement Find;

	@FindBy(css = "input[name='New']")
	public WebElement New;

	@FindBy(css = "select[name='bill_lading_id']")
	public WebElement billladingid;

	@FindBy(css = "input[name='container']")
	public WebElement container;

	@FindBy(css = "input[name='cFirms']")
	public WebElement cFirms;

	@FindBy(css = "input[name='cIRSNumber']")
	public WebElement cIRSNumber;

	@FindBy(xpath = "//table[@id='dataTable']//tbody//tr")
	public WebElement TableRow;

	@FindBy(xpath = "//div[@id='CreateDataDiv']//img[@id='img_find']")
	public WebElement billFind;

	@FindBy(xpath = "//input[@name='objCheckBox']")
	public WebElement objCheckBox;

	@FindBy(css = "input[name='Save']")
	public WebElement objChecksave;

	@FindBy(xpath = "//*[@id='MainDataDiv']/input")
