...
public class VesselArrivalpage {
	...
	@FindBy(xpath = "//a[contains(text(),'Vessel Arrival')]")
	...
	@FindBy(css = "input[id='arrivalDate0']")
	public WebElement arrivalDate;

	@FindBy(xpath = "//tr[@class='GridData']")
	public WebElement tableRow;

	@FindBy(xpath = "//*[@id='tr0']/td[4]")
	public WebElement UpdatedUser;

	@FindBy(css = "input[name='acknowledgement']")
	public WebElement acknowledgement;

	@FindBy(xpath = "//div[@id='acknowledgementDiv']//tr[@class='GridHeader']")
	public WebElement acknowledgementRow;

	@FindBy(xpath = "//td[contains(text(),'Vessel Arrival')]")
